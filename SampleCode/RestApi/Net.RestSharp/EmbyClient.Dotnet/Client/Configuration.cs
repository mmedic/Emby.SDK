...
namespace EmbyClient.Dotnet.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "4.9.3.0";
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "/4.9.3.0/dotnet"
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 4.9.3.0\n";
            report += "    SDK Package Version: 4.9.3.0\n";
